...
YOUR_API_KEY = "8Ytn-wBh0soC3fWo5_7gbuJtklv9HxhGZEQ0Yxf001c"
...
api_Call_url = f"https://places.ls.hereapi.com/places/v1/autosuggest?at=28.681909,77.344841&apiKey={YOUR_API_KEY}"
data = requests.get(api_Call_url)
print(data.json())